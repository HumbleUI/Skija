...
def main():
  ...
  for name in ['skija-shared', 'skija-windows-x64', 'skija-windows-arm64', 'skija-linux-x64', 'skija-linux-arm64', 'skija-macos-x64', 'skija-macos-arm64', 'skija-android-arm64', 'skija-android-x64']:
