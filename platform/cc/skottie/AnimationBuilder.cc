...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_skottie_AnimationBuilder__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteAnimationBuilder));
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_skottie_AnimationBuilder__1nMake
  (JNIEnv* env, jclass jclass, jint flags) {
    return reinterpret_cast<jlong>(new Animation::Builder(flags));
}

extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_skottie_AnimationBuilder__1nSetFontManager
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_skottie_AnimationBuilder__1nSetLogger
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_skottie_AnimationBuilder__1nSetResourceProvider
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_skottie_AnimationBuilder__1nBuildFromData
