...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nGetFinalizer
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nMakeFromData
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nRender
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nSeek
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nSeekFrame
  (JNIEnv* env, jclass jclass, jlong ptr, jfloat t, jlong icPtr) {
    Animation* instance = reinterpret_cast<Animation*>(static_cast<uintptr_t>(ptr));
    sksg::InvalidationController* controller = reinterpret_cast<sksg::InvalidationController*>(static_cast<uintptr_t>(icPtr));
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nSeekFrameTime
  (JNIEnv* env, jclass jclass, jlong ptr, jfloat t, jlong icPtr) {
    Animation* instance = reinterpret_cast<Animation*>(static_cast<uintptr_t>(ptr));
    sksg::InvalidationController* controller = reinterpret_cast<sksg::InvalidationController*>(static_cast<uintptr_t>(icPtr));
...
extern "C" JNIEXPORT jfloat JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nGetDuration
  (JNIEnv* env, jclass jclass, jlong ptr) {
    Animation* instance = reinterpret_cast<Animation*>(static_cast<uintptr_t>(ptr));
    return (jfloat) instance->duration();
}

extern "C" JNIEXPORT jfloat JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nGetFPS
  (JNIEnv* env, jclass jclass, jlong ptr) {
    Animation* instance = reinterpret_cast<Animation*>(static_cast<uintptr_t>(ptr));
    return (jfloat) instance->fps();
}

extern "C" JNIEXPORT jfloat JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nGetInPoint
  (JNIEnv* env, jclass jclass, jlong ptr) {
    Animation* instance = reinterpret_cast<Animation*>(static_cast<uintptr_t>(ptr));
    return (jfloat) instance->inPoint();
}

extern "C" JNIEXPORT jfloat JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nGetOutPoint
  (JNIEnv* env, jclass jclass, jlong ptr) {
    Animation* instance = reinterpret_cast<Animation*>(static_cast<uintptr_t>(ptr));
    return (jfloat) instance->outPoint();
}

extern "C" JNIEXPORT jstring JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nGetVersion
  (JNIEnv* env, jclass jclass, jlong ptr) {
    Animation* instance = reinterpret_cast<Animation*>(static_cast<uintptr_t>(ptr));
    return javaString(env, instance->version());
}

extern "C" JNIEXPORT jobject JNICALL Java_io_github_humbleui_skija_skottie_Animation__1nGetSize
  (JNIEnv* env, jclass jclass, jlong ptr) {
    Animation* instance = reinterpret_cast<Animation*>(static_cast<uintptr_t>(ptr));
