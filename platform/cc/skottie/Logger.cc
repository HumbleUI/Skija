...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_skottie_Logger__1nMake
  (JNIEnv* env, jclass jclass) {
    SkijaLoggerImpl* instance = new SkijaLoggerImpl();
    return reinterpret_cast<jlong>(instance);
}

extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_skottie_Logger__1nInit
