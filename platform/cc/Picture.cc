...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Picture__1nMakeFromData
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_Picture__1nPlayback
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Picture__1nSerializeToData
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkPicture* instance = reinterpret_cast<SkPicture*>(static_cast<uintptr_t>(ptr));
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Picture__1nMakePlaceholder
...
extern "C" JNIEXPORT jint JNICALL Java_io_github_humbleui_skija_Picture__1nGetApproximateOpCount
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkPicture* instance = reinterpret_cast<SkPicture*>(static_cast<uintptr_t>(ptr));
    return instance->approximateOpCount();
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Picture__1nGetApproximateBytesUsed
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkPicture* instance = reinterpret_cast<SkPicture*>(static_cast<uintptr_t>(ptr));
    return instance->approximateBytesUsed();
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Picture__1nMakeShader
