...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Drawable__1nMake
  (JNIEnv* env, jclass jclass) {
    SkijaDrawableImpl* instance = new SkijaDrawableImpl();
    return reinterpret_cast<jlong>(instance);
}

extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_Drawable__1nInit
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_Drawable__1nDraw
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_Drawable__1nNotifyDrawingChanged
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkijaDrawableImpl* instance = reinterpret_cast<SkijaDrawableImpl*>(static_cast<uintptr_t>(ptr));
