...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Codec__1nGetFinalizer(JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteCodec));
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Codec__1nMakeFromData
...
extern "C" JNIEXPORT jobject JNICALL Java_io_github_humbleui_skija_Codec__1nGetImageInfo
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Codec__1nGetSize
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkCodec* instance = reinterpret_cast<SkCodec*>(static_cast<uintptr_t>(ptr));
    return packISize(instance->dimensions());
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Codec__1nGetEncodedOrigin
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkCodec* instance = reinterpret_cast<SkCodec*>(static_cast<uintptr_t>(ptr));
    return static_cast<jint>(instance->getOrigin());
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Codec__1nGetEncodedImageFormat
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkCodec* instance = reinterpret_cast<SkCodec*>(static_cast<uintptr_t>(ptr));
    return static_cast<jint>(instance->getEncodedFormat());
}

extern "C" JNIEXPORT jint JNICALL Java_io_github_humbleui_skija_Codec__1nReadPixels
...
extern "C" JNIEXPORT jint JNICALL Java_io_github_humbleui_skija_Codec__1nGetFrameCount
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkCodec* instance = reinterpret_cast<SkCodec*>(static_cast<uintptr_t>(ptr));
...
extern "C" JNIEXPORT jint JNICALL Java_io_github_humbleui_skija_Codec__1nGetRepetitionCount
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkCodec* instance = reinterpret_cast<SkCodec*>(static_cast<uintptr_t>(ptr));
