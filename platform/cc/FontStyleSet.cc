...
extern "C" JNIEXPORT jint JNICALL Java_io_github_humbleui_skija_FontStyleSet__1nGetStyle
...
extern "C" JNIEXPORT jstring JNICALL Java_io_github_humbleui_skija_FontStyleSet__1nGetStyleName
  (JNIEnv* env, jclass jclass, jlong ptr, jint index) {
    SkFontStyleSet* instance = reinterpret_cast<SkFontStyleSet*>(static_cast<uintptr_t>(ptr));
    SkString style;
