...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_svg_SVGDOM__1nMakeFromData
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_svg_SVGDOM__1nGetRoot
...
extern "C" JNIEXPORT jobject JNICALL Java_io_github_humbleui_skija_svg_SVGDOM__1nGetContainerSize
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkSVGDOM* instance = reinterpret_cast<SkSVGDOM*>(static_cast<uintptr_t>(ptr));
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_svg_SVGDOM__1nRender
