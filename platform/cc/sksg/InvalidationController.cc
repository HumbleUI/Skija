...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_sksg_InvalidationController__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteInvalidationController));
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_sksg_InvalidationController__1nMake
  (JNIEnv* env, jclass jclass) {
    InvalidationController* instance = new InvalidationController();
    return reinterpret_cast<jlong>(instance);
}

extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_sksg_InvalidationController__1nInvalidate
