...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PathSegmentIterator__1nMake
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PathSegmentIterator__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deletePathSegmentIterator));
}

extern "C" JNIEXPORT jobject JNICALL Java_io_github_humbleui_skija_PathSegmentIterator__1nNext
