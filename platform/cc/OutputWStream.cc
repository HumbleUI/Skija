...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_OutputWStream__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteOutputWStream));
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_OutputWStream__1nMake
