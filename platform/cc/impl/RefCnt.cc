...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_impl_RefCnt__1nGetFinalizer(JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&unrefSkRefCnt));
}

extern "C" JNIEXPORT jint JNICALL Java_io_github_humbleui_skija_impl_RefCnt__1nGetRefCount(JNIEnv* env, jclass jclass, jlong ptr) {
