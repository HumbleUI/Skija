...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_ManagedString__1nGetFinalizer
...
extern "C" JNIEXPORT jobject JNICALL Java_io_github_humbleui_skija_ManagedString__1nToString
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkString* instance = reinterpret_cast<SkString*>(static_cast<uintptr_t>(ptr));
    return javaString(env, *instance);
}

extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_ManagedString__1nInsert
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_ManagedString__1nRemove
