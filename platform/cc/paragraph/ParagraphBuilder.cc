...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_paragraph_ParagraphBuilder__1nMake
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_paragraph_ParagraphBuilder__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteParagraphBuilder));
}

extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_paragraph_ParagraphBuilder__1nPushStyle
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_paragraph_ParagraphBuilder__1nPopStyle
  (JNIEnv* env, jclass jclass, jlong ptr, jlong textStylePtr) {
    ParagraphBuilder* instance = reinterpret_cast<ParagraphBuilder*>(static_cast<uintptr_t>(ptr));
    instance->pop();
}
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_paragraph_ParagraphBuilder__1nAddPlaceholder
