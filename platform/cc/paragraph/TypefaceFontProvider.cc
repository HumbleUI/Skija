...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_paragraph_TypefaceFontProvider__1nMake
  (JNIEnv* env, jclass jclass) {
    TypefaceFontProvider* instance = new TypefaceFontProvider();
    return reinterpret_cast<jlong>(instance);
}

extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_paragraph_TypefaceFontProvider__1nRegisterTypeface
