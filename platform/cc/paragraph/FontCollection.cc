...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_paragraph_FontCollection__1nMake
  (JNIEnv* env, jclass jclass) {
    FontCollection* ptr = new FontCollection();
    return reinterpret_cast<jlong>(ptr);
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_paragraph_FontCollection__1nGetFontManagersCount
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_paragraph_FontCollection__1nSetAssetFontManager
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_paragraph_FontCollection__1nSetDynamicFontManager
  (JNIEnv* env, jclass jclass, jlong ptr, jlong fontManagerPtr, jstring defaultFamilyNameStr) {
    FontCollection* instance = reinterpret_cast<FontCollection*>(static_cast<uintptr_t>(ptr));
    SkFontMgr* fontManager = reinterpret_cast<SkFontMgr*>(static_cast<uintptr_t>(fontManagerPtr));
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_paragraph_FontCollection__1nSetDefaultFontManager
  (JNIEnv* env, jclass jclass, jlong ptr, jlong fontManagerPtr, jstring defaultFamilyNameStr) {
    FontCollection* instance = reinterpret_cast<FontCollection*>(static_cast<uintptr_t>(ptr));
    SkFontMgr* fontManager = reinterpret_cast<SkFontMgr*>(static_cast<uintptr_t>(fontManagerPtr));
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_paragraph_FontCollection__1nGetFallbackManager
  (JNIEnv* env, jclass jclass, jlong ptr) {
    FontCollection* instance = reinterpret_cast<FontCollection*>(static_cast<uintptr_t>(ptr));
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_paragraph_FontCollection__1nSetEnableFallback
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_paragraph_FontCollection__1nGetParagraphCache
  (JNIEnv* env, jclass jclass, jlong ptr) {
    FontCollection* instance = reinterpret_cast<FontCollection*>(static_cast<uintptr_t>(ptr));
