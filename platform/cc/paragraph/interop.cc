    ...
    namespace paragraph {
        namespace LineMetrics {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("io/github/humbleui/skija/paragraph/LineMetrics");
        ...
        namespace TextBox {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("io/github/humbleui/skija/paragraph/TextBox");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
        ...
        namespace DecorationStyle {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("io/github/humbleui/skija/paragraph/DecorationStyle");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
        ...
        namespace Shadow {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("io/github/humbleui/skija/paragraph/Shadow");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
