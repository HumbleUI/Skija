...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Data__1nGetFinalizer(JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteData));
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Data__1nSize
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkData* instance = reinterpret_cast<SkData*>(static_cast<uintptr_t>(ptr));
    return instance->size();
}

extern "C" JNIEXPORT jobject JNICALL Java_io_github_humbleui_skija_Data__1nToByteBuffer
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkData* instance = reinterpret_cast<SkData*>(static_cast<uintptr_t>(ptr));
    return env->NewDirectByteBuffer(instance->writable_data(), instance->size());
}

extern "C" JNIEXPORT jbyteArray JNICALL Java_io_github_humbleui_skija_Data__1nBytes
...
extern "C" JNIEXPORT jboolean JNICALL Java_io_github_humbleui_skija_Data__1nEquals
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Data__1nMakeFromBytes
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Data__1nMakeSubset
  (JNIEnv* env, jclass jclass, jlong ptr, jlong offset, jlong length) {
    SkData* instance = reinterpret_cast<SkData*>(static_cast<uintptr_t>(ptr));
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_Data__1nMakeEmpty
