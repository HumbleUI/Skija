...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_TextBlobBuilder__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteTextBlobBuilder));
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_TextBlobBuilder__1nMake
  (JNIEnv* env, jclass jclass) {
    return reinterpret_cast<jlong>(new SkTextBlobBuilder());
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_TextBlobBuilder__1nBuild
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_TextBlobBuilder__1nAppendRun
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_TextBlobBuilder__1nAppendRunPosH
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_TextBlobBuilder__1nAppendRunPos
...
extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_TextBlobBuilder__1nAppendRunRSXform
