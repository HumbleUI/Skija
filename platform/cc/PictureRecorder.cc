...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PictureRecorder__1nMake
  (JNIEnv* env, jclass jclass) {
    SkPictureRecorder* instance = new SkPictureRecorder();
    return reinterpret_cast<jlong>(instance);
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PictureRecorder__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deletePictureRecorder));
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PictureRecorder__1nBeginRecording
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PictureRecorder__1nFinishRecordingAsPictureWithCull
  (JNIEnv* env, jclass jclass, jlong ptr, jfloat left, jfloat top, jfloat right, jfloat bottom) {
    SkPictureRecorder* instance = reinterpret_cast<SkPictureRecorder*>(static_cast<uintptr_t>(ptr));
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PictureRecorder__1nFinishRecordingAsDrawable
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkPictureRecorder* instance = reinterpret_cast<SkPictureRecorder*>(static_cast<uintptr_t>(ptr));
