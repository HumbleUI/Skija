...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_shaper_TextBlobBuilderRunHandler__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteTextBlobBuilderRunHandler));
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_shaper_TextBlobBuilderRunHandler__1nMake
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_shaper_TextBlobBuilderRunHandler__1nMakeBlob
