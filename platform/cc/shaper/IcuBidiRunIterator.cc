...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_shaper_IcuBidiRunIterator__1nMake
...
extern "C" JNIEXPORT jint JNICALL Java_io_github_humbleui_skija_shaper_IcuBidiRunIterator__1nGetCurrentLevel
