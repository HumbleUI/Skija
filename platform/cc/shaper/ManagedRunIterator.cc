...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_shaper_ManagedRunIterator__1nGetFinalizer(JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteRunIterator));
}

extern "C" JNIEXPORT void JNICALL Java_io_github_humbleui_skija_shaper_ManagedRunIterator__1nConsume
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkShaper::RunIterator* instance = reinterpret_cast<SkShaper::RunIterator*>(static_cast<uintptr_t>(ptr));
    instance->consume();
}

extern "C" JNIEXPORT jint JNICALL Java_io_github_humbleui_skija_shaper_ManagedRunIterator__1nGetEndOfCurrentRun
...
extern "C" JNIEXPORT jboolean JNICALL Java_io_github_humbleui_skija_shaper_ManagedRunIterator__1nIsAtEnd
  (JNIEnv* env, jclass jclass, jlong ptr) {
    SkShaper::RunIterator* instance = reinterpret_cast<SkShaper::RunIterator*>(static_cast<uintptr_t>(ptr));
