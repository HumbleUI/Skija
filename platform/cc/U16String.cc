...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_U16String__1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteU16String));
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_U16String__1nMake
...
extern "C" JNIEXPORT jobject JNICALL Java_io_github_humbleui_skija_U16String__1nToString
