...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_MaskFilter__1nMakeBlur
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_MaskFilter__1nMakeShader
...
// extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_MaskFilter__1nMakeEmboss
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_MaskFilter__1nMakeTable
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_MaskFilter__1nMakeGamma
  (JNIEnv* env, jclass jclass, jfloat gamma) {
    SkMaskFilter* ptr = SkTableMaskFilter::CreateGamma(gamma);
    return reinterpret_cast<jlong>(ptr);
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_MaskFilter__1nMakeClip
