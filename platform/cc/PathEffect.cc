...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PathEffect__1nMakeSum
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PathEffect__1nMakeCompose
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PathEffect__1nMakePath1D
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PathEffect__1nMakePath2D
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PathEffect__1nMakeLine2D
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PathEffect__1nMakeCorner
  (JNIEnv* env, jclass jclass, jfloat radius) {
    SkPathEffect* ptr = SkCornerPathEffect::Make(radius).release();
    return reinterpret_cast<jlong>(ptr);
}

extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PathEffect__1nMakeDash
...
extern "C" JNIEXPORT jlong JNICALL Java_io_github_humbleui_skija_PathEffect__1nMakeDiscrete
